...
801011f5:	e8 d6 34 00 00       	call   801046d0 <memset>
  log_write(bp);
...
801013f1:	e8 8a 33 00 00       	call   80104780 <memmove>
  brelse(bp);
...
801014a6:	e8 d5 2f 00 00       	call   80104480 <initlock>
...
801014bf:	e8 8c 2e 00 00       	call   80104350 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010159e:	e8 2d 31 00 00       	call   801046d0 <memset>
      dip->type = type;
...
80101641:	e8 3a 31 00 00       	call   80104780 <memmove>
  log_write(bp);
...
8010166f:	e8 4c 2f 00 00       	call   801045c0 <acquire>
  ip->ref++;
...
801016b2:	e8 d9 2c 00 00       	call   80104390 <acquiresleep>
  if(ip->valid == 0){
...
80101728:	e8 53 30 00 00       	call   80104780 <memmove>
    brelse(bp);
...
80101783:	e8 a8 2c 00 00       	call   80104430 <holdingsleep>
...
8010179e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010179f:	e9 4c 2c 00 00       	jmp    801043f0 <releasesleep>
    panic("iunlock");
...
801017d0:	e8 bb 2b 00 00       	call   80104390 <acquiresleep>
...
801017ea:	e8 01 2c 00 00       	call   801043f0 <releasesleep>
  acquire(&icache.lock);
801017ef:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017f6:	e8 c5 2d 00 00       	call   801045c0 <acquire>
  ip->ref--;
...
80101820:	e8 9b 2d 00 00       	call   801045c0 <acquire>
    int r = ip->ref;
...
80101a15:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a17:	e8 64 2d 00 00       	call   80104780 <memmove>
    brelse(bp);
...
80101b13:	e8 68 2c 00 00       	call   80104780 <memmove>
    log_write(bp);
...
80101bae:	e8 3d 2c 00 00       	call   801047f0 <strncmp>
}
80101bb3:	c9                   	leave  
80101bb4:	c3                   	ret    
...
80101c0d:	e8 de 2b 00 00       	call   801047f0 <strncmp>
      continue;
...
80101c99:	e8 22 29 00 00       	call   801045c0 <acquire>
  ip->ref++;
...
80101d05:	e8 76 2a 00 00       	call   80104780 <memmove>
    path++;
...
80101d98:	e8 e3 29 00 00       	call   80104780 <memmove>
    name[len] = 0;
...
80101e8d:	e8 be 29 00 00       	call   80104850 <strncpy>
  de.inum = inum;
...
80101ed8:	68 3e 7a 10 80       	push   $0x80107a3e
...
80102020:	e8 5b 24 00 00       	call   80104480 <initlock>
...
8010209e:	e8 1d 25 00 00       	call   801045c0 <acquire>
...
8010213e:	e8 ed 22 00 00       	call   80104430 <holdingsleep>
...
80102178:	e8 43 24 00 00       	call   801045c0 <acquire>
...
80102398:	e8 23 22 00 00       	call   801045c0 <acquire>
...
80102415:	e8 66 20 00 00       	call   80104480 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102503:	e8 b8 20 00 00       	call   801045c0 <acquire>
  r = kmem.freelist;
...
80102947:	e8 d4 1d 00 00       	call   80104720 <memcmp>
...
80102a74:	e8 07 1d 00 00       	call   80104780 <memmove>
...
80102b24:	e8 57 19 00 00       	call   80104480 <initlock>
  readsb(dev, &sb);
80102b29:	58                   	pop    %eax
...
80102bbb:	e8 00 1a 00 00       	call   801045c0 <acquire>
...
80102c2e:	e8 8d 19 00 00       	call   801045c0 <acquire>
  log.outstanding -= 1;
...
80102cc6:	e8 b5 1a 00 00       	call   80104780 <memmove>
...
80102d0f:	e8 ac 18 00 00       	call   801045c0 <acquire>
    wakeup(&log);
...
80102d22:	00 00 00 
    wakeup(&log);
80102d25:	e8 a6 12 00 00       	call   80103fd0 <wakeup>
    release(&log.lock);
...
80102d50:	e8 7b 12 00 00       	call   80103fd0 <wakeup>
  release(&log.lock);
...
80102e72:	e8 19 2c 00 00       	call   80105a90 <idtinit>
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 e5 3c 00 00       	call   80106b80 <switchkvm>
  seginit();
80102e9b:	e8 50 3c 00 00       	call   80106af0 <seginit>
  lapicinit();
...
80102ed1:	e8 7a 41 00 00       	call   80107050 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 75 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 0b 3c 00 00       	call   80106af0 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 c7 2e 00 00       	call   80105dc0 <uartinit>
  pinit();         // process table
80102ef9:	e8 52 08 00 00       	call   80103750 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 0d 2b 00 00       	call   80105a10 <tvinit>
  binit();         // buffer cache
...
80102f24:	e8 57 18 00 00       	call   80104780 <memmove>
...
80103004:	e8 17 17 00 00       	call   80104720 <memcmp>
...
801030c2:	e8 59 16 00 00       	call   80104720 <memcmp>
...
80103203:	68 7d 77 10 80       	push   $0x8010777d
80103208:	e8 83 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010320d:	83 ec 0c             	sub    $0xc,%esp
80103210:	68 9c 77 10 80       	push   $0x8010779c
...
80103311:	e8 6a 11 00 00       	call   80104480 <initlock>
  (*f0)->type = FD_PIPE;
...
8010336f:	e8 4c 12 00 00       	call   801045c0 <acquire>
  if(writable){
...
8010338f:	e8 3c 0c 00 00       	call   80103fd0 <wakeup>
...
801033d4:	e8 f7 0b 00 00       	call   80103fd0 <wakeup>
...
8010340d:	e8 ae 11 00 00       	call   801045c0 <acquire>
  for(i = 0; i < n; i++){
...
801034f3:	e8 d8 0a 00 00       	call   80103fd0 <wakeup>
  release(&p->lock);
...
80103520:	e8 9b 10 00 00       	call   801045c0 <acquire>
...
801035e7:	e8 e4 09 00 00       	call   80103fd0 <wakeup>
  release(&p->lock);
...
80103621:	e8 9a 0f 00 00       	call   801045c0 <acquire>
...
80103674:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010367a:	e8 01 10 00 00       	call   80104680 <release>
...
8010369c:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010369f:	c7 40 14 f7 59 10 80 	movl   $0x801059f7,0x14(%eax)
  p->context = (struct context*)sp;
...
801036ae:	e8 1d 10 00 00       	call   801046d0 <memset>
...
801036da:	e8 a1 0f 00 00       	call   80104680 <release>
}
...
80103756:	68 d5 77 10 80       	push   $0x801077d5
8010375b:	68 20 2d 11 80       	push   $0x80112d20
80103760:	e8 1b 0d 00 00       	call   80104480 <initlock>
}
...
80103814:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103817:	e8 d4 0c 00 00       	call   801044f0 <pushcli>
  c = mycpu();
8010381c:	e8 4f ff ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103821:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103827:	e8 04 0d 00 00       	call   80104530 <popcli>
}
...
80103853:	e8 78 37 00 00       	call   80106fd0 <setupkvm>
...
80103871:	e8 3a 34 00 00       	call   80106cb0 <inituvm>
...
80103886:	e8 45 0e 00 00       	call   801046d0 <memset>
...
801038df:	68 05 78 10 80       	push   $0x80107805
801038e4:	50                   	push   %eax
801038e5:	e8 c6 0f 00 00       	call   801048b0 <safestrcpy>
  p->cwd = namei("/");
801038ea:	c7 04 24 0e 78 10 80 	movl   $0x8010780e,(%esp)
...
80103923:	68 ec 77 10 80       	push   $0x801077ec
...
80103935:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103938:	e8 b3 0b 00 00       	call   801044f0 <pushcli>
  c = mycpu();
8010393d:	e8 2e fe ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103942:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103948:	e8 e3 0b 00 00       	call   80104530 <popcli>
  if(n > 0){
...
8010395c:	e8 3f 32 00 00       	call   80106ba0 <switchuvm>
  return 0;
...
8010397a:	e8 71 34 00 00       	call   80106df0 <allocuvm>
...
8010399a:	e8 81 35 00 00       	call   80106f20 <deallocuvm>
...
801039b6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039b9:	e8 32 0b 00 00       	call   801044f0 <pushcli>
  c = mycpu();
801039be:	e8 ad fd ff ff       	call   80103770 <mycpu>
  p = c->proc;
801039c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039c9:	e8 62 0b 00 00       	call   80104530 <popcli>
  if((np = allocproc()) == 0){
...
801039e8:	e8 b3 36 00 00       	call   801070a0 <copyuvm>
...
80103a61:	e8 4a 0e 00 00       	call   801048b0 <safestrcpy>
  pid = np->pid;
...
80103a83:	e8 f8 0b 00 00       	call   80104680 <release>
  return pid;
...
80103afb:	e8 c0 0a 00 00       	call   801045c0 <acquire>
...
80103b14:	75 0b                	jne    80103b21 <scheduler+0x51>
80103b16:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
80103b1c:	39 cf                	cmp    %ecx,%edi
80103b1e:	0f 4c f9             	cmovl  %ecx,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b21:	05 84 00 00 00       	add    $0x84,%eax
80103b26:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103b2b:	72 e3                	jb     80103b10 <scheduler+0x40>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b2d:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103b32:	eb 12                	jmp    80103b46 <scheduler+0x76>
80103b34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103b38:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103b3e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103b44:	73 6a                	jae    80103bb0 <scheduler+0xe0>
      if(p->state != RUNNABLE)
80103b46:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103b4a:	75 ec                	jne    80103b38 <scheduler+0x68>
      if(p->prio != highprio)
80103b4c:	39 bb 80 00 00 00    	cmp    %edi,0x80(%ebx)
80103b52:	75 e4                	jne    80103b38 <scheduler+0x68>
      switchuvm(p);
80103b54:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103b57:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
80103b5d:	53                   	push   %ebx
80103b5e:	e8 3d 30 00 00       	call   80106ba0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103b63:	58                   	pop    %eax
80103b64:	5a                   	pop    %edx
80103b65:	ff 73 1c             	pushl  0x1c(%ebx)
80103b68:	ff 75 e4             	pushl  -0x1c(%ebp)
      p->switches += 1;
80103b6b:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
      p->state = RUNNING;
80103b6f:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b76:	e8 90 0d 00 00       	call   8010490b <swtch>
      switchkvm();
80103b7b:	e8 00 30 00 00       	call   80106b80 <switchkvm>
      if(p->prio > 0){
80103b80:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80103b86:	83 c4 10             	add    $0x10,%esp
80103b89:	85 c0                	test   %eax,%eax
80103b8b:	7e 09                	jle    80103b96 <scheduler+0xc6>
        p->prio -= 1;
80103b8d:	83 e8 01             	sub    $0x1,%eax
80103b90:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b96:	81 c3 84 00 00 00    	add    $0x84,%ebx
      c->proc = 0;
80103b9c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103ba3:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ba6:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103bac:	72 98                	jb     80103b46 <scheduler+0x76>
80103bae:	66 90                	xchg   %ax,%ax
    release(&ptable.lock);
80103bb0:	83 ec 0c             	sub    $0xc,%esp
80103bb3:	68 20 2d 11 80       	push   $0x80112d20
80103bb8:	e8 c3 0a 00 00       	call   80104680 <release>
    sti();
80103bbd:	83 c4 10             	add    $0x10,%esp
80103bc0:	e9 2b ff ff ff       	jmp    80103af0 <scheduler+0x20>
...
80103c33:	e8 d3 0c 00 00       	call   8010490b <swtch>
  mycpu()->intena = intena;
...
80103c96:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c99:	e8 52 08 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103c9e:	e8 cd fa ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103ca3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ca9:	e8 82 08 00 00       	call   80104530 <popcli>
  if(curproc == initproc)
...
80103cdd:	75 e1                	jne    80103cc0 <exit+0x30>
  begin_op();
80103cdf:	e8 cc ee ff ff       	call   80102bb0 <begin_op>
  iput(curproc->cwd);
80103ce4:	83 ec 0c             	sub    $0xc,%esp
80103ce7:	ff 76 68             	pushl  0x68(%esi)
80103cea:	e8 d1 da ff ff       	call   801017c0 <iput>
  end_op();
80103cef:	e8 2c ef ff ff       	call   80102c20 <end_op>
  curproc->cwd = 0;
80103cf4:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103cfb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d02:	e8 b9 08 00 00       	call   801045c0 <acquire>
...
80103d18:	05 84 00 00 00       	add    $0x84,%eax
80103d1d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103d2f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d36:	05 84 00 00 00       	add    $0x84,%eax
80103d3b:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103d4f:	90                   	nop
80103d50:	81 c2 84 00 00 00    	add    $0x84,%edx
80103d56:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
...
80103d78:	05 84 00 00 00       	add    $0x84,%eax
80103d7d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103da7:	68 5d 78 10 80       	push   $0x8010785d
80103dac:	e8 df c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103db1:	83 ec 0c             	sub    $0xc,%esp
80103db4:	68 50 78 10 80       	push   $0x80107850
...
80103dcc:	e8 ef 07 00 00       	call   801045c0 <acquire>
  pushcli();
80103dd1:	e8 1a 07 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103dd6:	e8 95 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103ddb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103de1:	e8 4a 07 00 00       	call   80104530 <popcli>
...
80103df9:	e8 82 08 00 00       	call   80104680 <release>
}
...
80103e1c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e1f:	e8 cc 06 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103e24:	e8 47 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103e29:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e2f:	e8 fc 06 00 00       	call   80104530 <popcli>
  if(p == 0)
...
80103e50:	e8 6b 07 00 00       	call   801045c0 <acquire>
    release(lk);
80103e55:	89 34 24             	mov    %esi,(%esp)
80103e58:	e8 23 08 00 00       	call   80104680 <release>
  p->chan = chan;
...
80103e7a:	e8 01 08 00 00       	call   80104680 <release>
    acquire(lk);
...
80103e8b:	5d                   	pop    %ebp
    acquire(lk);
80103e8c:	e9 2f 07 00 00       	jmp    801045c0 <acquire>
...
80103eb9:	68 6f 78 10 80       	push   $0x8010786f
80103ebe:	e8 cd c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103ec3:	83 ec 0c             	sub    $0xc,%esp
80103ec6:	68 69 78 10 80       	push   $0x80107869
...
80103ed4:	53                   	push   %ebx
  pushcli();
80103ed5:	e8 16 06 00 00       	call   801044f0 <pushcli>
  c = mycpu();
80103eda:	e8 91 f8 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103edf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ee5:	e8 46 06 00 00       	call   80104530 <popcli>
  acquire(&ptable.lock);
80103eea:	83 ec 0c             	sub    $0xc,%esp
80103eed:	68 20 2d 11 80       	push   $0x80112d20
80103ef2:	e8 c9 06 00 00       	call   801045c0 <acquire>
...
80103f08:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103f0e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
...
80103f1f:	74 37                	je     80103f58 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f21:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80103f27:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f2c:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
...
80103f5e:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103f61:	e8 ba e3 ff ff       	call   80102320 <kfree>
        freevm(p->pgdir);
80103f66:	5a                   	pop    %edx
...
80103f6a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f71:	e8 da 2f 00 00       	call   80106f50 <freevm>
        release(&ptable.lock);
...
80103f96:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f9d:	e8 de 06 00 00       	call   80104680 <release>
        return pid;
...
80103fbb:	e8 c0 06 00 00       	call   80104680 <release>
      return -1;
...
80103fdf:	e8 dc 05 00 00       	call   801045c0 <acquire>
...
80103ff5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80104013:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80104024:	c9                   	leave  
  release(&ptable.lock);
80104025:	e9 56 06 00 00       	jmp    80104680 <release>
...
8010403f:	e8 7c 05 00 00       	call   801045c0 <acquire>
...
80104050:	05 84 00 00 00       	add    $0x84,%eax
80104055:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
8010407d:	e8 fe 05 00 00       	call   80104680 <release>
      return 0;
...
80104098:	e8 e3 05 00 00       	call   80104680 <release>
  return -1;
...
801040cb:	68 67 7c 10 80       	push   $0x80107c67
801040d0:	e8 8b c5 ff ff       	call   80100660 <cprintf>
801040d5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040d8:	81 c3 84 00 00 00    	add    $0x84,%ebx
801040de:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
801040e4:	0f 83 96 00 00 00    	jae    80104180 <procdump+0xd0>
    if(p->state == UNUSED)
801040ea:	8b 43 0c             	mov    0xc(%ebx),%eax
801040ed:	85 c0                	test   %eax,%eax
801040ef:	74 e7                	je     801040d8 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040f1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040f4:	ba 80 78 10 80       	mov    $0x80107880,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040f9:	77 11                	ja     8010410c <procdump+0x5c>
801040fb:	8b 14 85 18 79 10 80 	mov    -0x7fef86e8(,%eax,4),%edx
      state = "???";
80104102:	b8 80 78 10 80       	mov    $0x80107880,%eax
80104107:	85 d2                	test   %edx,%edx
80104109:	0f 44 d0             	cmove  %eax,%edx
    cprintf("PID: %d PPID:  %d Priority: %d Switches: %d State: %s Name: %s", p->pid, p->parent->pid, p->prio, p->switches, state, p->name);
8010410c:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010410f:	83 ec 04             	sub    $0x4,%esp
80104112:	50                   	push   %eax
80104113:	8b 43 14             	mov    0x14(%ebx),%eax
80104116:	52                   	push   %edx
80104117:	ff 73 7c             	pushl  0x7c(%ebx)
8010411a:	ff b3 80 00 00 00    	pushl  0x80(%ebx)
80104120:	ff 70 10             	pushl  0x10(%eax)
80104123:	ff 73 10             	pushl  0x10(%ebx)
80104126:	68 d8 78 10 80       	push   $0x801078d8
8010412b:	e8 30 c5 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
80104130:	83 c4 20             	add    $0x20,%esp
80104133:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80104137:	75 8f                	jne    801040c8 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104139:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010413c:	83 ec 08             	sub    $0x8,%esp
8010413f:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104142:	50                   	push   %eax
80104143:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104146:	8b 40 0c             	mov    0xc(%eax),%eax
80104149:	83 c0 08             	add    $0x8,%eax
8010414c:	50                   	push   %eax
8010414d:	e8 4e 03 00 00       	call   801044a0 <getcallerpcs>
80104152:	83 c4 10             	add    $0x10,%esp
80104155:	8d 76 00             	lea    0x0(%esi),%esi
      for(i=0; i<10 && pc[i] != 0; i++)
80104158:	8b 17                	mov    (%edi),%edx
8010415a:	85 d2                	test   %edx,%edx
8010415c:	0f 84 66 ff ff ff    	je     801040c8 <procdump+0x18>
        cprintf(" %p", pc[i]);
80104162:	83 ec 08             	sub    $0x8,%esp
80104165:	83 c7 04             	add    $0x4,%edi
80104168:	52                   	push   %edx
80104169:	68 c1 72 10 80       	push   $0x801072c1
8010416e:	e8 ed c4 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104173:	83 c4 10             	add    $0x10,%esp
80104176:	39 fe                	cmp    %edi,%esi
80104178:	75 de                	jne    80104158 <procdump+0xa8>
8010417a:	e9 49 ff ff ff       	jmp    801040c8 <procdump+0x18>
8010417f:	90                   	nop
  }
}
...
8010419e:	e8 1d 04 00 00       	call   801045c0 <acquire>
...
801041c3:	72 eb                	jb     801041b0 <getNumProc+0x20>
  }

  release(&ptable.lock);
801041c5:	83 ec 0c             	sub    $0xc,%esp
801041c8:	68 20 2d 11 80       	push   $0x80112d20
801041cd:	e8 ae 04 00 00       	call   80104680 <release>
...
801041ee:	e8 cd 03 00 00       	call   801045c0 <acquire>
...
80104214:	72 ea                	jb     80104200 <getMaxPid+0x20>
  {
     if(p->pid > max)
        max = p->pid;
  }
...
8010421e:	e8 5d 04 00 00       	call   80104680 <release>
...
// populate given processInfo structure with
// the info about the process specified by 
// the given pid
int
...
80104243:	e8 78 03 00 00       	call   801045c0 <acquire>
80104248:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010424b:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104250:	eb 12                	jmp    80104264 <getProcInfo+0x34>
80104252:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104258:	05 84 00 00 00       	add    $0x84,%eax
8010425d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80104262:	73 2c                	jae    80104290 <getProcInfo+0x60>
    if(p->pid == pid){
80104264:	39 58 10             	cmp    %ebx,0x10(%eax)
80104267:	75 ef                	jne    80104258 <getProcInfo+0x28>
      PI->pid = pid;
80104269:	89 1e                	mov    %ebx,(%esi)
      PI->psize = p->sz;
8010426b:	8b 10                	mov    (%eax),%edx
      PI->numberContextSwitches = p->switches;
      release(&ptable.lock);
8010426d:	83 ec 0c             	sub    $0xc,%esp
      PI->psize = p->sz;
80104270:	89 56 04             	mov    %edx,0x4(%esi)
      PI->numberContextSwitches = p->switches;
80104273:	8b 40 7c             	mov    0x7c(%eax),%eax
80104276:	89 46 08             	mov    %eax,0x8(%esi)
      release(&ptable.lock);
80104279:	68 20 2d 11 80       	push   $0x80112d20
8010427e:	e8 fd 03 00 00       	call   80104680 <release>
      return 0;
...
80104298:	e8 e3 03 00 00       	call   80104680 <release>
  return -1;
...
801042b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801042b7:	e8 34 02 00 00       	call   801044f0 <pushcli>
  c = mycpu();
801042bc:	e8 af f4 ff ff       	call   80103770 <mycpu>
  p = c->proc;
801042c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042c7:	e8 64 02 00 00       	call   80104530 <popcli>
  int prio;
  struct proc *p = myproc();
  acquire(&ptable.lock);
801042cc:	83 ec 0c             	sub    $0xc,%esp
801042cf:	68 20 2d 11 80       	push   $0x80112d20
801042d4:	e8 e7 02 00 00       	call   801045c0 <acquire>
  prio = p->prio;
801042d9:	8b 9b 80 00 00 00    	mov    0x80(%ebx),%ebx
  release(&ptable.lock);
801042df:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801042e6:	e8 95 03 00 00       	call   80104680 <release>
  return(prio);
}
801042eb:	89 d8                	mov    %ebx,%eax
...
80104304:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104307:	e8 e4 01 00 00       	call   801044f0 <pushcli>
  c = mycpu();
8010430c:	e8 5f f4 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80104311:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104317:	e8 14 02 00 00       	call   80104530 <popcli>
  struct proc *p = myproc();
  acquire(&ptable.lock);
8010431c:	83 ec 0c             	sub    $0xc,%esp
8010431f:	68 20 2d 11 80       	push   $0x80112d20
80104324:	e8 97 02 00 00       	call   801045c0 <acquire>
  p->prio = prio;
80104329:	8b 45 08             	mov    0x8(%ebp),%eax
8010432c:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  release(&ptable.lock);
80104332:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104339:	e8 42 03 00 00       	call   80104680 <release>
  return 0;
}
...
8010435a:	68 30 79 10 80       	push   $0x80107930
...
801043b5:	e8 56 fa ff ff       	call   80103e10 <sleep>
  while (lk->locked) {
...
801043c3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801043c9:	e8 42 f4 ff ff       	call   80103810 <myproc>
...
80104414:	e8 b7 fb ff ff       	call   80103fd0 <wakeup>
  release(&lk->lk);
...
80104453:	e8 b8 f3 ff ff       	call   80103810 <myproc>
...
801044f9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801044fa:	e8 71 f2 ff ff       	call   80103770 <mycpu>
...
8010450f:	e8 5c f2 ff ff       	call   80103770 <mycpu>
80104514:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010451a:	e8 51 f2 ff ff       	call   80103770 <mycpu>
...
8010455c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104560:	e8 0b f2 ff ff       	call   80103770 <mycpu>
...
80104575:	68 3b 79 10 80       	push   $0x8010793b
8010457a:	e8 11 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010457f:	83 ec 0c             	sub    $0xc,%esp
80104582:	68 52 79 10 80       	push   $0x80107952
...
801045a8:	e8 c3 f1 ff ff       	call   80103770 <mycpu>
...
80104604:	e8 67 f1 ff ff       	call   80103770 <mycpu>
...
80104667:	68 59 79 10 80       	push   $0x80107959
...
801046bc:	68 61 79 10 80       	push   $0x80107961
...
80104927:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010492a:	e8 e1 ee ff ff       	call   80103810 <myproc>
...
80104967:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010496a:	e8 a1 ee ff ff       	call   80103810 <myproc>
...
801049d5:	e8 36 ee ff ff       	call   80103810 <myproc>
...
801049e3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049e6:	e8 25 ee ff ff       	call   80103810 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104a28:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a2b:	e8 e0 ed ff ff       	call   80103810 <myproc>
...
80104ac4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104ac7:	e8 44 ed ff ff       	call   80103810 <myproc>
...
80104ad7:	83 fa 1c             	cmp    $0x1c,%edx
80104ada:	77 1c                	ja     80104af8 <syscall+0x38>
80104adc:	8b 14 85 a0 79 10 80 	mov    -0x7fef8660(,%eax,4),%edx
...
80104b00:	68 69 79 10 80       	push   $0x80107969
...
80104b5e:	e8 5d d0 ff ff       	call   80101bc0 <dirlookup>
80104b63:	83 c4 10             	add    $0x10,%esp
80104b66:	85 c0                	test   %eax,%eax
80104b68:	89 c7                	mov    %eax,%edi
80104b6a:	74 34                	je     80104ba0 <create+0x80>
    iunlockput(dp);
80104b6c:	83 ec 0c             	sub    $0xc,%esp
80104b6f:	53                   	push   %ebx
80104b70:	e8 ab cd ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104b75:	89 3c 24             	mov    %edi,(%esp)
80104b78:	e8 13 cb ff ff       	call   80101690 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104b7d:	83 c4 10             	add    $0x10,%esp
80104b80:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104b85:	0f 85 95 00 00 00    	jne    80104c20 <create+0x100>
80104b8b:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104b90:	0f 85 8a 00 00 00    	jne    80104c20 <create+0x100>
...
80104baa:	e8 71 c9 ff ff       	call   80101520 <ialloc>
...
80104bc0:	e8 cb ca ff ff       	call   80101690 <ilock>
  ip->major = major;
...
80104be1:	e8 fa c9 ff ff       	call   801015e0 <iupdate>
...
80104c0c:	e8 0f cd ff ff       	call   80101920 <iunlockput>
  return ip;
...
80104c24:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104c26:	e8 f5 cc ff ff       	call   80101920 <iunlockput>
    return 0;
...
80104c49:	e8 92 c9 ff ff       	call   801015e0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c4e:	83 c4 0c             	add    $0xc,%esp
80104c51:	ff 77 04             	pushl  0x4(%edi)
80104c54:	68 34 7a 10 80       	push   $0x80107a34
...
80104c6c:	68 33 7a 10 80       	push   $0x80107a33
...
80104ce4:	e8 27 eb ff ff       	call   80103810 <myproc>
...
80104d29:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d2b:	e8 e0 ea ff ff       	call   80103810 <myproc>
...
80104e73:	78 2b                	js     80104ea0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e75:	e8 96 e9 ff ff       	call   80103810 <myproc>
...
80104f43:	e8 a8 cf ff ff       	call   80101ef0 <namei>
...
80104f78:	e8 63 c6 ff ff       	call   801015e0 <iupdate>
  iunlock(ip);
80104f7d:	89 1c 24             	mov    %ebx,(%esp)
80104f80:	e8 eb c7 ff ff       	call   80101770 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104f85:	58                   	pop    %eax
80104f86:	5a                   	pop    %edx
80104f87:	57                   	push   %edi
80104f88:	ff 75 d0             	pushl  -0x30(%ebp)
80104f8b:	e8 80 cf ff ff       	call   80101f10 <nameiparent>
...
80104f9d:	e8 ee c6 ff ff       	call   80101690 <ilock>
...
80104fb3:	e8 78 ce ff ff       	call   80101e30 <dirlink>
...
80104fc3:	e8 58 c9 ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104fc8:	89 1c 24             	mov    %ebx,(%esp)
80104fcb:	e8 f0 c7 ff ff       	call   801017c0 <iput>
  end_op();
...
80104ff8:	e8 93 c6 ff ff       	call   80101690 <ilock>
  ip->nlink--;
80104ffd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105002:	89 1c 24             	mov    %ebx,(%esp)
80105005:	e8 d6 c5 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
...
8010503d:	eb 9b                	jmp    80104fda <sys_link+0xda>
    end_op();
8010503f:	e8 dc db ff ff       	call   80102c20 <end_op>
    return -1;
...
8010506f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105072:	e8 39 db ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105077:	83 ec 08             	sub    $0x8,%esp
8010507a:	53                   	push   %ebx
8010507b:	ff 75 c0             	pushl  -0x40(%ebp)
8010507e:	e8 8d ce ff ff       	call   80101f10 <nameiparent>
...
80105094:	e8 f7 c5 ff ff       	call   80101690 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105099:	58                   	pop    %eax
8010509a:	5a                   	pop    %edx
8010509b:	68 34 7a 10 80       	push   $0x80107a34
801050a0:	53                   	push   %ebx
801050a1:	e8 fa ca ff ff       	call   80101ba0 <namecmp>
...
801050b4:	68 33 7a 10 80       	push   $0x80107a33
801050b9:	53                   	push   %ebx
801050ba:	e8 e1 ca ff ff       	call   80101ba0 <namecmp>
...
801050d3:	e8 e8 ca ff ff       	call   80101bc0 <dirlookup>
...
801050e9:	e8 a2 c5 ff ff       	call   80101690 <ilock>
  if(ip->nlink < 1)
...
8010511d:	e8 4e c9 ff ff       	call   80101a70 <writei>
...
8010513d:	e8 de c7 ff ff       	call   80101920 <iunlockput>
  ip->nlink--;
80105142:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105147:	89 1c 24             	mov    %ebx,(%esp)
8010514a:	e8 91 c4 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
8010514f:	89 1c 24             	mov    %ebx,(%esp)
80105152:	e8 c9 c7 ff ff       	call   80101920 <iunlockput>
  end_op();
80105157:	e8 c4 da ff ff       	call   80102c20 <end_op>
  return 0;
...
80105194:	e8 d7 c7 ff ff       	call   80101970 <readi>
...
801051ac:	e8 6f c7 ff ff       	call   80101920 <iunlockput>
    goto bad;
801051b1:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
801051b4:	83 ec 0c             	sub    $0xc,%esp
801051b7:	56                   	push   %esi
801051b8:	e8 63 c7 ff ff       	call   80101920 <iunlockput>
  end_op();
801051bd:	e8 5e da ff ff       	call   80102c20 <end_op>
  return -1;
...
8010527d:	e8 6e cc ff ff       	call   80101ef0 <namei>
...
80105293:	e8 f8 c3 ff ff       	call   80101690 <ilock>
...
801052af:	0f 84 a6 00 00 00    	je     8010535b <sys_open+0x12b>
  struct proc *curproc = myproc();
801052b5:	e8 56 e5 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801052dc:	e8 8f c4 ff ff       	call   80101770 <iunlock>
  end_op();
801052e1:	e8 3a d9 ff ff       	call   80102c20 <end_op>
...
801053cf:	e8 4c c5 ff ff       	call   80101920 <iunlockput>
  end_op();
...
8010545e:	e8 bd c4 ff ff       	call   80101920 <iunlockput>
  end_op();
...
80105485:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105488:	e8 83 e3 ff ff       	call   80103810 <myproc>
8010548d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010548f:	e8 1c d7 ff ff       	call   80102bb0 <begin_op>
...
801054af:	e8 3c ca ff ff       	call   80101ef0 <namei>
...
801054c1:	e8 ca c1 ff ff       	call   80101690 <ilock>
  if(ip->type != T_DIR){
...
801054d4:	e8 97 c2 ff ff       	call   80101770 <iunlock>
  iput(curproc->cwd);
801054d9:	58                   	pop    %eax
801054da:	ff 76 68             	pushl  0x68(%esi)
801054dd:	e8 de c2 ff ff       	call   801017c0 <iput>
  end_op();
801054e2:	e8 39 d7 ff ff       	call   80102c20 <end_op>
  curproc->cwd = ip;
...
80105504:	e8 17 c4 ff ff       	call   80101920 <iunlockput>
    end_op();
...
8010564c:	e8 ff db ff ff       	call   80103250 <pipealloc>
...
8010565f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105661:	e8 aa e1 ff ff       	call   80103810 <myproc>
...
80105687:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010568a:	e8 81 e1 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801056c8:	e8 43 e1 ff ff       	call   80103810 <myproc>
...
80105703:	5d                   	pop    %ebp
  return fork();
80105704:	e9 a7 e2 ff ff       	jmp    801039b0 <fork>
...
80105713:	83 ec 08             	sub    $0x8,%esp
  exit();
80105716:	e8 75 e5 ff ff       	call   80103c90 <exit>
...
80105723:	5d                   	pop    %ebp
  return wait();
80105724:	e9 a7 e7 ff ff       	jmp    80103ed0 <wait>
...
8010574e:	e8 dd e8 ff ff       	call   80104030 <kill>
...
80105773:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105776:	e8 95 e0 ff ff       	call   80103810 <myproc>
...
80105797:	78 27                	js     801057c0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105799:	e8 72 e0 ff ff       	call   80103810 <myproc>
  if(growproc(n) < 0)
...
801057a6:	e8 85 e1 ff ff       	call   80103930 <growproc>
...
801057fd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105800:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
80105818:	68 a0 56 11 80       	push   $0x801156a0
8010581d:	e8 ee e5 ff ff       	call   80103e10 <sleep>
  while(ticks - ticks0 < n){
80105822:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
8010582f:	73 2f                	jae    80105860 <sys_sleep+0x90>
    if(myproc()->killed){
80105831:	e8 da df ff ff       	call   80103810 <myproc>
...
80105840:	68 60 4e 11 80       	push   $0x80114e60
...
80105884:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105887:	68 60 4e 11 80       	push   $0x80114e60
8010588c:	e8 2f ed ff ff       	call   801045c0 <acquire>
  xticks = ticks;
80105891:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80105897:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
...
801058b3:	83 ec 14             	sub    $0x14,%esp
  cprintf("hello\n");
801058b6:	68 79 7a 10 80       	push   $0x80107a79
...
801058dc:	e8 9f f1 ff ff       	call   80104a80 <argstr>
801058e1:	83 c4 10             	add    $0x10,%esp
801058e4:	85 c0                	test   %eax,%eax
801058e6:	78 18                	js     80105900 <sys_helloYou+0x30>
    return -1;
 cprintf("hello %s\n", n);
801058e8:	83 ec 08             	sub    $0x8,%esp
801058eb:	ff 75 f4             	pushl  -0xc(%ebp)
801058ee:	68 80 7a 10 80       	push   $0x80107a80
801058f3:	e8 68 ad ff ff       	call   80100660 <cprintf>
 return 0;
...
80105913:	5d                   	pop    %ebp
  return(getNumProc());
80105914:	e9 77 e8 ff ff       	jmp    80104190 <getNumProc>
80105919:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105920 <sys_getMaxPid>:
...
80105923:	5d                   	pop    %ebp
  return(getMaxPid());
80105924:	e9 b7 e8 ff ff       	jmp    801041e0 <getMaxPid>
80105929:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105930 <sys_getProcInfo>:
...
80105983:	5d                   	pop    %ebp
  return(getPrio());
80105984:	e9 27 e9 ff ff       	jmp    801042b0 <getPrio>
80105989:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105990 <sys_setprio>:
...
8010599c:	e8 2f f0 ff ff       	call   801049d0 <argint>
801059a1:	83 c4 10             	add    $0x10,%esp
801059a4:	85 c0                	test   %eax,%eax
801059a6:	78 18                	js     801059c0 <sys_setprio+0x30>
    return -1;
  setPrio(prio);
801059a8:	83 ec 0c             	sub    $0xc,%esp
801059ab:	ff 75 f4             	pushl  -0xc(%ebp)
801059ae:	e8 4d e9 ff ff       	call   80104300 <setPrio>
  return 0;
...
801059d3:	83 ec 08             	sub    $0x8,%esp
  procdump();
801059d6:	e8 d5 e6 ff ff       	call   801040b0 <procdump>
  return 0;
}
...
80105a27:	c7 04 c5 a2 4e 11 80 	movl   $0x8e000008,-0x7feeb15e(,%eax,8)
80105a2e:	08 00 00 8e 
80105a32:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105a39:	80 
80105a3a:	c1 ea 10             	shr    $0x10,%edx
80105a3d:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
80105a44:	80 
  for(i = 0; i < 256; i++)
...
80105a54:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a57:	c7 05 a2 50 11 80 08 	movl   $0xef000008,0x801150a2
80105a5e:	00 00 ef 
  initlock(&tickslock, "time");
80105a61:	68 8a 7a 10 80       	push   $0x80107a8a
80105a66:	68 60 4e 11 80       	push   $0x80114e60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a6b:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105a71:	c1 e8 10             	shr    $0x10,%eax
80105a74:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
80105a7a:	e8 01 ea ff ff       	call   80104480 <initlock>
}
...
80105a9b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a9f:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
80105ae0:	ff 24 85 30 7b 10 80 	jmp    *-0x7fef84d0(,%eax,4)
...
80105af0:	e8 1b dd ff ff       	call   80103810 <myproc>
...
80105b10:	e8 db dc ff ff       	call   801037f0 <cpuid>
...
80105b21:	e8 ea dc ff ff       	call   80103810 <myproc>
...
80105b45:	68 ec 7a 10 80       	push   $0x80107aec
80105b4a:	e8 11 ab ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105b4f:	83 c4 20             	add    $0x20,%esp
80105b52:	e8 b9 dc ff ff       	call   80103810 <myproc>
...
80105b5e:	e8 ad dc ff ff       	call   80103810 <myproc>
80105b63:	85 c0                	test   %eax,%eax
80105b65:	74 1d                	je     80105b84 <trap+0xc4>
80105b67:	e8 a4 dc ff ff       	call   80103810 <myproc>
...
80105b84:	e8 87 dc ff ff       	call   80103810 <myproc>
80105b89:	85 c0                	test   %eax,%eax
80105b8b:	74 0b                	je     80105b98 <trap+0xd8>
80105b8d:	e8 7e dc ff ff       	call   80103810 <myproc>
...
80105b96:	74 68                	je     80105c00 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b98:	e8 73 dc ff ff       	call   80103810 <myproc>
80105b9d:	85 c0                	test   %eax,%eax
80105b9f:	74 19                	je     80105bba <trap+0xfa>
80105ba1:	e8 6a dc ff ff       	call   80103810 <myproc>
...
80105bd2:	0f 85 e8 00 00 00    	jne    80105cc0 <trap+0x200>
    myproc()->tf = tf;
80105bd8:	e8 33 dc ff ff       	call   80103810 <myproc>
80105bdd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105be0:	e8 db ee ff ff       	call   80104ac0 <syscall>
    if(myproc()->killed)
80105be5:	e8 26 dc ff ff       	call   80103810 <myproc>
...
80105c04:	75 92                	jne    80105b98 <trap+0xd8>
    yield();
80105c06:	e8 b5 e1 ff ff       	call   80103dc0 <yield>
80105c0b:	eb 8b                	jmp    80105b98 <trap+0xd8>
80105c0d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105c10:	e8 db db ff ff       	call   801037f0 <cpuid>
80105c15:	85 c0                	test   %eax,%eax
80105c17:	0f 84 c3 00 00 00    	je     80105ce0 <trap+0x220>
    lapiceoi();
80105c1d:	e8 3e cb ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c22:	e8 e9 db ff ff       	call   80103810 <myproc>
...
80105c34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c38:	e8 e3 c9 ff ff       	call   80102620 <kbdintr>
    lapiceoi();
80105c3d:	e8 1e cb ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105c58:	e8 53 02 00 00       	call   80105eb0 <uartintr>
    lapiceoi();
80105c5d:	e8 fe ca ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105c7f:	e8 6c db ff ff       	call   801037f0 <cpuid>
80105c84:	56                   	push   %esi
80105c85:	53                   	push   %ebx
80105c86:	50                   	push   %eax
80105c87:	68 94 7a 10 80       	push   $0x80107a94
80105c8c:	e8 cf a9 ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105c91:	e8 ca ca ff ff       	call   80102760 <lapiceoi>
    break;
...
80105cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105cb0:	e8 db c3 ff ff       	call   80102090 <ideintr>
...
80105ce3:	68 60 4e 11 80       	push   $0x80114e60
80105ce8:	e8 d3 e8 ff ff       	call   801045c0 <acquire>
      wakeup(&ticks);
80105ced:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105cf4:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
80105cfb:	e8 d0 e2 ff ff       	call   80103fd0 <wakeup>
      release(&tickslock);
80105d00:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105d07:	e8 74 e9 ff ff       	call   80104680 <release>
80105d0c:	83 c4 10             	add    $0x10,%esp
80105d0f:	e9 09 ff ff ff       	jmp    80105c1d <trap+0x15d>
80105d14:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d17:	e8 d4 da ff ff       	call   801037f0 <cpuid>
...
80105d25:	68 b8 7a 10 80       	push   $0x80107ab8
80105d2a:	e8 31 a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105d2f:	83 c4 14             	add    $0x14,%esp
80105d32:	68 8f 7a 10 80       	push   $0x80107a8f
...
80105d95:	e8 e6 c9 ff ff       	call   80102780 <microdelay>
...
80105e2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e2f:	bb b0 7b 10 80       	mov    $0x80107bb0,%ebx
  ioapicenable(IRQ_COM1, 0);
80105e34:	6a 00                	push   $0x0
80105e36:	6a 04                	push   $0x4
80105e38:	e8 a3 c4 ff ff       	call   801022e0 <ioapicenable>
...
80106984:	e8 47 bb ff ff       	call   801024d0 <kalloc>
...
8010699a:	e8 31 dd ff ff       	call   801046d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a3d:	68 b8 7b 10 80       	push   $0x80107bb8
...
80106a94:	e8 87 b8 ff ff       	call   80102320 <kfree>
      *pte = 0;
...
80106af3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106af6:	e8 f5 cc ff ff       	call   801037f0 <cpuid>
...
80106b80:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106bc4:	0f 84 c2 00 00 00    	je     80106c8c <switchuvm+0xec>
  pushcli();
80106bca:	e8 21 d9 ff ff       	call   801044f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bcf:	e8 9c cb ff ff       	call   80103770 <mycpu>
80106bd4:	89 c6                	mov    %eax,%esi
80106bd6:	e8 95 cb ff ff       	call   80103770 <mycpu>
80106bdb:	89 c7                	mov    %eax,%edi
80106bdd:	e8 8e cb ff ff       	call   80103770 <mycpu>
80106be2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106be5:	83 c7 08             	add    $0x8,%edi
80106be8:	e8 83 cb ff ff       	call   80103770 <mycpu>
...
80106c31:	e8 3a cb ff ff       	call   80103770 <mycpu>
...
80106c49:	e8 22 cb ff ff       	call   80103770 <mycpu>
80106c4e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106c54:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c57:	e8 14 cb ff ff       	call   80103770 <mycpu>
...
80106ccb:	77 49                	ja     80106d16 <inituvm+0x66>
  mem = kalloc();
80106ccd:	e8 fe b7 ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106cdf:	e8 ec d9 ff ff       	call   801046d0 <memset>
...
80106d10:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d11:	e9 6a da ff ff       	jmp    80104780 <memmove>
    panic("inituvm: more than a page");
80106d16:	83 ec 0c             	sub    $0xc,%esp
80106d19:	68 fd 7b 10 80       	push   $0x80107bfd
...
80106da1:	e8 ca ab ff ff       	call   80101970 <readi>
...
80106e3b:	e8 90 d8 ff ff       	call   801046d0 <memset>
...
80106e69:	0f 86 81 00 00 00    	jbe    80106ef0 <allocuvm+0x100>
    mem = kalloc();
80106e6f:	e8 5c b6 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106e7d:	68 35 7c 10 80       	push   $0x80107c35
...
80106eb3:	68 4d 7c 10 80       	push   $0x80107c4d
...
80106edb:	e8 40 b4 ff ff       	call   80102320 <kfree>
      return 0;
...
80106f9e:	e8 7d b3 ff ff       	call   80102320 <kfree>
...
80106fb3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106fb4:	e9 67 b3 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80106fb9:	83 ec 0c             	sub    $0xc,%esp
80106fbc:	68 69 7c 10 80       	push   $0x80107c69
...
80106fd5:	e8 f6 b4 ff ff       	call   801024d0 <kalloc>
...
80106ff0:	e8 db d6 ff ff       	call   801046d0 <memset>
...
8010705b:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010708f:	68 7a 7c 10 80       	push   $0x80107c7a
...
801070e0:	e8 9b d6 ff ff       	call   80104780 <memmove>
...
80107135:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107138:	e8 93 b3 ff ff       	call   801024d0 <kalloc>
...
8010720f:	e8 6c d5 ff ff       	call   80104780 <memmove>
    len -= n;
    buf += n;
