...
int main(void)
{
   ...
   e:	51                   	push   %ecx
  int pid = getpid();
   f:	e8 1e 03 00 00       	call   332 <getpid>
  14:	89 c3                	mov    %eax,%ebx
  printf(1, "%d priority is %d\n", pid, getprio());
  16:	e8 5f 03 00 00       	call   37a <getprio>
  1b:	50                   	push   %eax
  1c:	53                   	push   %ebx
  ...
  setprio(8);
  29:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  30:	e8 4d 03 00 00       	call   382 <setprio>
  printf(1, "set priority to 8");
  35:	58                   	pop    %eax
  36:	5a                   	pop    %edx
  37:	68 ab 07 00 00       	push   $0x7ab
  3c:	6a 01                	push   $0x1
  3e:	e8 fd 03 00 00       	call   440 <printf>
  printf(1, "%d priority is %d\n", pid, getprio());
  43:	e8 32 03 00 00       	call   37a <getprio>
  48:	50                   	push   %eax
  49:	53                   	push   %ebx
  4a:	68 98 07 00 00       	push   $0x798
  4f:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb bd 07 00 00       	mov    $0x7bd,%ebx
        while(*s != 0){
