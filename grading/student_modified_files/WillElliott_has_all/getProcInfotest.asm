...
int main(void)
{
  ...
  12:	6a 0c                	push   $0xc
  14:	e8 17 07 00 00       	call   730 <malloc>
  ...
  1d:	53                   	push   %ebx
  1e:	6a 01                	push   $0x1
  20:	e8 dd 03 00 00       	call   402 <getProcInfo>
  printf(1, "PID: %d\n", PI->pid);
  25:	83 c4 0c             	add    $0xc,%esp
  28:	ff 33                	pushl  (%ebx)
  2a:	68 28 08 00 00       	push   $0x828
  2f:	6a 01                	push   $0x1
  31:	e8 9a 04 00 00       	call   4d0 <printf>
  printf(1, "Process size: %d bytes\n", PI->psize);
  36:	83 c4 0c             	add    $0xc,%esp
  39:	ff 73 04             	pushl  0x4(%ebx)
  3c:	68 31 08 00 00       	push   $0x831
  41:	6a 01                	push   $0x1
  ...
  4e:	68 4c 08 00 00       	push   $0x84c
  53:	6a 01                	push   $0x1
  55:	e8 76 04 00 00       	call   4d0 <printf>
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 74 08 00 00 	movzbl 0x874(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 6c 08 00 00       	mov    $0x86c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 1c 0b 00 00       	mov    %eax,0xb1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 7f7:	0b 00 00 
 7fa:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 20 0b 00 00       	mov    $0xb20,%eax
 809:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 810:	00 00 00 
