...
int main(void)
{
  ...
  11:	e8 1c 03 00 00       	call   332 <getNumProc>
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 88 07 00 00 	movzbl 0x788(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 81 07 00 00       	mov    $0x781,%ebx
        while(*s != 0){
 ...
 5e1:	a1 2c 0a 00 00       	mov    0xa2c,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 2c 0a 00 00       	mov    %eax,0xa2c
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 2c 0a 00 00    	mov    0xa2c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 2c 0a 00 00    	mov    %edx,0xa2c
}
 ...
 737:	0a 00 00 
 73a:	c7 05 30 0a 00 00 30 	movl   $0xa30,0xa30
 741:	0a 00 00 
    base.s.size = 0;
 744:	b8 30 0a 00 00       	mov    $0xa30,%eax
 749:	c7 05 34 0a 00 00 00 	movl   $0x0,0xa34
 750:	00 00 00 
